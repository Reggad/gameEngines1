...
namespace BGE
{
	...
	public:
		...
		shared_ptr<PhysicsController> CreateTBox(float width, float height, float depth, float massOfBox,glm::vec3 pos, glm::quat quat);
		...
		void CreateRagDoll(glm::vec3 torsoCenter);
